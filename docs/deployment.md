...
3. Edit `.env` and set:
   ...
   - `BOOTSTRAP_ADMINS` to a comma-separated list of GitHub usernames that should receive the Administrator role on first login in development/POC environments
...
| `DEV_MODE` | No | Enables development-only debug tooling and session role impersonation. Default: `"false"` |
