...
| Method | Path | Description | Roles |
|---|---|---|---|
| GET | `/assessments` | Assessment hub for launching evidence-first workflows from inventory | Administrator, Assessor |

### Assessments (Wizard)

| Method | Path | Description | Roles |
|---|---|---|---|
| GET | `/wizard/new` | Artefact Information form (step 1), pre-populated from the selected inventory item | Administrator, Assessor |
| POST | `/wizard/new` | Submit step 1, create in-memory AssessmentState using inventory-backed metadata, redirect to step 2 | Administrator, Assessor |
...
| Method | Path | Description | Roles |
|---|---|---|---|
| POST | `/inventory/{id}/discovery/refresh` | Re-run OCI metadata and evidence discovery for an inventory item | Administrator, Assessor |

### Deprecated OCI Discovery

| Method | Path | Description | Roles |
|---|---|---|---|
| GET | `/oci/discover` | Deprecated administrator-only page that points users back to inventory-based discovery | Administrator |
